...
class ActionLayer(BaseActionLayer):
    ...
    def _competing_needs(self, actionA, actionB):
        ...
        # TODO: implement this function
        # raise NotImplementedError
        return any(self.parent_layer.is_mutex(a,b) for a in actionA.preconditions for b in actionB.preconditions) or any(self.parent_layer.is_mutex(a, b) for a in actionA.preconditions for b in actionB.preconditions)
